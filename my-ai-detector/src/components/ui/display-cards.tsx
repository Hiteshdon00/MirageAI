...
import { Sparkles, ShieldCheck, Search, Video } from "lucide-react";
...
export default function DisplayCards() {
  const hackTechCards = [
    {
      title: "Text Analysis",
      description: "Detecting AI-generated articles",
      date: "HackTech Engine v1.0",
    ...
    },
    {
      ...
      description: "Video manipulation detection",
      date: "HackTech Real-time",
      icon: <Video className="size-4 text-blue-300" />,
      className: "[grid-area:stack] translate-x-16 translate-y-10 hover:-translate-y-1 before:absolute before:w-[100%] before:outline-1 before:rounded-xl before:outline-border before:h-[100%] before:content-[''] before:bg-blend-overlay before:bg-background/50 grayscale-[100%] hover:before:opacity-0 before:transition-opacity before:duration-700 hover:grayscale-0 before:left-0 before:top-0",
    },
    {
      title: "Content Trust",
      description: "Verified by HackTech",
      date: "Authenticity Confirmed",
  ...
  return (
    <div className="grid [grid-template-areas:'stack'] place-items-center opacity-100 animate-in fade-in-0 duration-700">
      {hackTechCards.map((cardProps, index) => (
